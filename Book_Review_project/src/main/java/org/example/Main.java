...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        outputDevice.writeMessage("3. Exit");
    ...
    private static void addReview(Scanner scanner, OutputDevice outputDevice, Book book) {
        ...
        app.addReviewToBook(book, reviewText, rating);
    }
    ...
    private static void addRating(Scanner scanner, OutputDevice outputDevice, Book book) {
        ...
        // Use the addRatingToBook method in Application to add and save the rating
        app.addRatingToBook(book, rating);
    }
